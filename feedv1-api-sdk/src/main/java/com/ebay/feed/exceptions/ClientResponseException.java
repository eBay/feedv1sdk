...
/**
 * The ClientResponseException class extends the Exception class and is used to handle exceptions specific to the client's response.
...
public class ClientResponseException extends Exception {
    /**
     * This constructor is used to create a new ClientResponseException with a specific message.
     *
    ...
    /**
     * This constructor is used to create a new ClientResponseException with a specific message and cause.
     *
     * @param message A string containing the detail message, which is saved for later retrieval by the Throwable.getMessage() method.
